...
# Data Reads
```{r read}
routes_df <- read_csv(paste0(processed_dir, VERSION, "/", "routes.txt"), col_types = "icccciccc")
freq_df <- read_csv(paste0(processed_dir, VERSION, "/", "frequencies.txt"), col_types = "iitt")
trips_df <- read_csv(paste0(processed_dir, VERSION, "/", "trips.txt"), col_types = "iiiciii")
stops_df <- read_csv(paste0(processed_dir, VERSION, "/", "stops.txt"), col_types  = "iccddicccc")
shapes_df <- read_csv(paste0(processed_dir, VERSION, "/", "shapes.txt"), col_types = "iiccc")
stop_times_df <- read_csv(paste0(processed_dir, VERSION, "/", "stop_times.txt"), col_types = "ittiicccn")
